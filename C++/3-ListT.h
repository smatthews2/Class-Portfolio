/* Author: Sebastian Matthews
    CPSC 122 01 Project 11: Writing a Doubly Linked List Class
    April 1, 2022
    Gonzaga University
    This program demonstrates the implementation of a doubly linked list class, with all the functions filled out and tested in the main file.
