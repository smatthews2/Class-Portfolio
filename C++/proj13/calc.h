/*    Author: Sebastian Matthews
      CPSC 122 01 Project 13: A Calculator, Part I
      April 22, 2022
      Gonzaga University
      This program is the first part of a calculator, utilizing a stack(which inherits a list) to check parentheses and do other prescribed tasks.
      To Compile: make
